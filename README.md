# Patent Landscaping — 2026-06 Snorkel vs MAS Weak-Supervision Study

> **Scope:** This README documents the June 2026 academic study: pseudo-labeling
> with Snorkel or MAS, followed by a controlled SciBERT comparison. The July 2026
> query-driven direct-judgment system is documented separately in `README_MAS.md`.
> See `PROJECT_MAP.md` for the relationship between the two projects.
