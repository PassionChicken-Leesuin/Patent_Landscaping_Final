...
- **C1.** The invention must enable full-body control and balance in humanoid robots, including bipedal locomotion and whole-body dynamics.
...
- **C2.** The invention must facilitate advanced manipulation capabilities, including robotic hands, grippers, and tactile sensing.
...
- **C3.** The invention must involve learning and control of multi-joint manipulation, including motion planning and force control.
...
- **C4.** The invention must include joint actuators and reducers, such as quasi-direct drive (QDD) and series elastic actuators (SEA).
...
- **C5.** The invention must support robot vision, vision-language-action (VLA) models, and imitation learning for humanoid robots.
...
- **C6.** The invention must ensure safe human-robot collaboration, including collision detection and avoidance, and speed and separation monitoring.
...
- [CONDITIONAL] **robotic navigation and path planning** — Included if the navigation and path planning are specific to humanoid robots, otherwise excluded if for general robotics.
- [OUT] **robotic assembly systems** — Excluded as they focus on industrial assembly processes not specific to humanoid robots.
...
- **Q1. Should wearable robots be included if they contribute to humanoid robot functionalities?**
  - 영향: Wearable robots may have components or technologies applicable to humanoid robots, affecting domain inclusion.
  - 선택지: Include wearable robots if they contribute to humanoid functionalities., Exclude all wearable robots regardless of contribution.
  - 미응답 기본값: Exclude all wearable robots unless they contribute to humanoid functionalities.
- **Q2. Should robotic devices for niche applications be included if they serve humanoid robot functionalities?**
  - 영향: Niche applications may have technologies applicable to humanoid robots, affecting domain inclusion.
  - 선택지: Include niche applications if they serve humanoid functionalities., Exclude all niche applications regardless of contribution.
  - 미응답 기본값: Exclude all niche applications unless they serve humanoid functionalities.
