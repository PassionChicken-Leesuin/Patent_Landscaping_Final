...
- **C6.** The invention must implement or improve consensus mechanisms such as proof-of-work or proof-of-stake.
  - 근거: https://en.wikipedia.org/wiki/Proof_of_work, https://en.wikipedia.org/wiki/Proof_of_stake
...
- [OUT] **Energy transactions using blockchain** — The inclusion of this cluster is not strongly supported by the web evidence, which does not emphasize energy transactions.
- [OUT] **Healthcare transaction validation** — The inclusion of this cluster is not strongly supported by the web evidence, which does not emphasize healthcare transactions.
