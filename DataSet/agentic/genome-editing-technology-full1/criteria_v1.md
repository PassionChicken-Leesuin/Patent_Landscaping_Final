...
## 도메인 정의
Genome editing technology encompasses methods and tools that enable precise modifications to the genetic material of living organisms. This includes the ability to insert, delete, or replace specific DNA sequences at targeted genomic locations, often using programmable nucleases like CRISPR-Cas9, TALENs, or prime editing systems. The technology must facilitate targeted modifications that can be heritable, and it should include mechanisms to minimize off-target effects, ensuring specificity and efficiency in the editing process.
...
- **C3.** The technology must be capable of editing genes in a way that is heritable in subsequent generations.
...
- [IN] **homologous recombination** — Homologous recombination is a technique used in genome editing to introduce specific DNA changes, aligning with the domain's purpose.
...
- [IN] **gene therapy applications** — Gene therapy applications that involve direct genome editing are within the scope, as they utilize genome editing technologies.
...
- **E2.** Patents related to vector production rather than direct genome editing are excluded, as they do not involve precise DNA modifications.
  - 근거: corpus: suspected_boundary_cases
- **E3.** Patents discussing therapeutic delivery or medical monitoring without genome editing are excluded, as they do not involve direct genome editing techniques.
  - 근거: corpus: suspected_boundary_cases
