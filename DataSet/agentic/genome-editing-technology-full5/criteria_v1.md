...
- **C3.** The invention must be applicable to a variety of organisms, including plants, animals, and microorganisms, for purposes such as research, agriculture, or therapeutic development.
  - 근거: corpus: task, corpus: definition
- **C4.** The invention must facilitate the study of gene function or the development of genetically modified organisms.
  - 근거: corpus: task, corpus: definition
...
- **E1.** Patents that focus on gene expression modulation without involving direct genome editing techniques are excluded.
...
- **Q1. Should patents focusing on gene expression modulation without direct genome editing techniques be included?**
  - 영향: This determines whether indirect applications of genome editing are within scope.
...
- **Q2. Should patents involving genetic modification for vector production be included?**
  - 영향: This affects the inclusion of patents that support genome editing indirectly.
...
- **Q3. Should patents discussing nucleic acid-based therapeutics without specific genome editing technologies be included?**
  - 영향: This affects the inclusion of therapeutic applications that may not directly involve genome editing.
