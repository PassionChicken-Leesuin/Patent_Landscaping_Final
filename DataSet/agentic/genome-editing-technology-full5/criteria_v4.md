...
- **C3.** The invention must be capable of performing genome editing tasks across a variety of organisms, including plants, animals, and microorganisms.
  - 근거: corpus: task, corpus: definition
- **C4.** The invention must facilitate genome editing processes that enable the study of gene function or the development of genetically modified organisms.
  - 근거: corpus: task, corpus: definition
...
- [CONDITIONAL] **gene therapy applications** — In if they involve genome editing technologies; out if they do not specify genome editing techniques.
...
- **E1.** Patents that focus on gene expression modulation tools that do not alter DNA sequences are excluded.
...
- **E2.** Patents involving genetic modification for vector production without direct genome editing are excluded.
  - 근거: corpus: suspected_boundary_cases
- **E3.** Patents discussing nucleic acid-based therapeutics that do not perform genome editing tasks are excluded.
  - 근거: corpus: suspected_boundary_cases
