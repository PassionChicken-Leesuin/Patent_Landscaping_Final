...
- [IN] **Medical Imaging** — Medical imaging often uses computer vision techniques for tasks like segmentation and feature extraction, which are core to the domain.
