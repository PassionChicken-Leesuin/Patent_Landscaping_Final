...
- **C1.** The invention must mention a specific method or technology for storing hydrogen, such as compression, liquefaction, or chemical storage using metal hydrides, in the title or abstract.
  - 근거: corpus: technique
...
- **C3.** The invention must reference safety measures related to hydrogen storage, such as 'leakage prevention', 'explosion risk', or 'flammability control', in the title or abstract.
  - 근거: corpus: task
- **C4.** The invention must include terms related to optimizing hydrogen storage efficiency, such as 'volume efficiency', 'weight efficiency', or 'advanced materials' like MOFs or nanomaterials, in the title or abstract.
  - 근거: corpus: technique
...
- **E2.** Patents that involve hydrogen utilization in applications like fuel cells or industrial processes without focusing on storage are excluded.
  - 근거: corpus: task
- **E3.** Patents that focus on hydrogen purification or utilization technologies without a direct link to storage processes are excluded.
  - 근거: corpus: task
