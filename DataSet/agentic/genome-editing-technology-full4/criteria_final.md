...
- **C7.** The invention must involve the use of prime editing techniques, which allow for precise genome modifications without double strand breaks or donor DNA templates.
  - 근거: corpus: definition, corpus: technique
...
- **E2.** Patents involving genetic modification in specific organisms without broader genome editing context are excluded unless they involve precise genome editing techniques.
  - 근거: corpus: suspected_boundary_cases
...
- **E4.** Patents discussing high-throughput screening methods without direct genome editing are excluded.
  - 근거: corpus: suspected_boundary_cases
- **E5.** Patents involving plant biotechnology applications without explicit genome editing techniques are excluded unless they involve precise genome editing techniques.
  - 근거: corpus: suspected_boundary_cases
