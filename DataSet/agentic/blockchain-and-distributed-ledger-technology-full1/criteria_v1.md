...
- **C3.** The invention must employ a consensus mechanism to validate transactions or data entries without a central authority.
...
- **E1.** Patents that mention blockchain but focus on unrelated primary functions, such as general data management or encryption without blockchain context, are excluded.
