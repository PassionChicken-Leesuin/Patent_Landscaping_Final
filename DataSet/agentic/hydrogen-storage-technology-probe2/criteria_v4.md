...
- **C5.** The invention must be scalable to accommodate varying quantities of hydrogen, allowing for flexibility in storage capacity.
  - 근거: https://www.energy.gov/eere/fuelcells/hydrogen-storage, https://www.sciencedirect.com/science/article/pii/S0360319919319335
- **C6.** The invention must enhance hydrogen storage capabilities, which can be inferred from improvements in storage density, efficiency, or safety.
  - 근거: https://en.wikipedia.org/wiki/Metal%E2%80%93organic_framework, https://www.sciencedirect.com/science/article/pii/S0360319919319335
...
- **E2.** Patents that use hydrogen in unrelated applications, such as semiconductor manufacturing or plastic decomposition, are excluded unless they specifically enhance hydrogen storage capabilities.
  - 근거: https://www.energy.gov/eere/fuelcells/hydrogen-storage
- **E3.** Patents related to hydrail applications are excluded unless they specifically address hydrogen storage as part of the transportation system.
  - 근거: https://www.energy.gov/eere/fuelcells/hydrogen-storage
...
- Advanced materials like MOFs are in if they enhance hydrogen storage capabilities.
- Include hydrail applications if they specifically address hydrogen storage as part of the transportation system.
