...
- **C1.** The invention must involve methods or materials specifically designed for hydrogen storage, such as mechanical, chemical, or nanomaterial-based approaches, and these must be identifiable from indicative terms or descriptions in the title or abstract.
  - 기술축: A1
  - [web/high] https://en.wikipedia.org/wiki/Hydrogen_storage: Hydrogen storage methods include mechanical approaches like high pressures and low temperatures, and chemical compounds that release H2 on demand.
  - [corpus/high] corpus: hydrogen storage materials: Hydrogen storage materials and methods for enhancing storage capacity
  - 레거시 출처: https://en.wikipedia.org/wiki/Hydrogen_storage, corpus: hydrogen storage materials
- **C2.** The invention must enable the efficient release of stored hydrogen, such as through controlled temperature or pressure changes, and this capability must be evident from indicative terms or descriptions in the title or abstract.
  - 기술축: A2
  - [web/high] https://en.wikipedia.org/wiki/Hydrogen_storage: The release temperature of hydrogen storage materials affects the cost of chemical storage strategies.
  - [user_query/high] query.json: The technology must allow for the efficient release of hydrogen when needed.
...
- [CONDITIONAL] **hydrogen generation systems** — Include if the generation system integrates storage technologies specifically designed for hydrogen storage.
...
- **E5.** Patents that focus on distribution systems that do not alter storage methods are excluded.
  - 기술축: A5
