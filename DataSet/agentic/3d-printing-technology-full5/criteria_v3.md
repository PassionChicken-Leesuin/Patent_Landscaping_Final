...
- **C4.** The invention must be capable of using multiple materials in the 3D printing process.
...
- [OUT] **Photolithography and Semiconductor Manufacturing** — These focus on semiconductor processes not specific to 3D printing technology, unless they directly involve additive manufacturing techniques.
