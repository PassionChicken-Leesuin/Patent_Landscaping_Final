...
- **C4.** The invention must be capable of using multiple materials in the 3D printing process if relevant to the specific process being claimed.
...
- [CONDITIONAL] **Photolithography and Semiconductor Manufacturing** — Include only if the semiconductor manufacturing process involves additive manufacturing techniques relevant to 3D printing.
...
- **E3.** Patents involving recycling materials without directly pertaining to the creation of new 3D printed objects are excluded.
  - 근거: corpus: suspected_boundary_cases
- **E4.** Patents that mention 3D printing but focus on integrating electronic devices without involving the creation of 3D printed objects as part of the integration process are excluded.
  - 근거: corpus: suspected_boundary_cases
- **E5.** Patents that involve 3D modeling but focus on surgical instruments without involving the creation of 3D printed objects are excluded.
  - 근거: corpus: suspected_boundary_cases
...
- Patents involving biological support design are excluded unless they involve traditional 3D printing of objects.
- Patents involving electronics integration are included only if they involve the creation of 3D printed objects as part of the integration process.
