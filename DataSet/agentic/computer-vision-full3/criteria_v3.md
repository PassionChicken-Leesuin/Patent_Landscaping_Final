...
- **C6.** The invention must involve 3D reconstruction or modeling from 2D image sequences.
  - 근거: corpus: definition, corpus: task
- **C7.** The invention must involve overlaying virtual objects onto real-world scenes, as in augmented reality applications.
  - 근거: corpus: definition, corpus: task
- **C8.** The invention must involve feature extraction from images or video data for further analysis or processing.
...
- **E2.** Patents that involve image processing focused solely on aesthetic enhancements without analytical tasks are excluded.
...
- Augmented reality applications are in scope if they involve overlaying virtual objects onto real-world scenes.
