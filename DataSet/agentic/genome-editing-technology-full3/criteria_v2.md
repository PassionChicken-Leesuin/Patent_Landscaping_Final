...
- **C4.** The invention must be applicable to a wide range of organisms, including plants, animals, and microorganisms.
  - 근거: corpus: task, corpus: technique
- **C5.** The invention must include prime editing as a recognized genome editing technique, allowing for direct writing of new genetic information into a targeted DNA site.
...
- **E3.** Patents discussing nucleic acid-based therapeutics without specific genome editing technologies are excluded as they do not perform genome editing tasks.
  - 근거: patent-pool: suspected_boundary_cases
- **E4.** Patents involving genetic modification for agricultural applications without precise genome editing techniques are excluded as they do not meet the domain's criteria for precision.
  - 근거: patent-pool: suspected_boundary_cases
