...
- **C4.** The invention must enable the production of complex geometries or customized objects that are difficult to achieve with traditional manufacturing methods.
  - 근거: https://www.3dprintingmedia.network/what-is-3d-printing/, https://www.sciencedirect.com/science/article/pii/S2214860420301234
- **C5.** The invention must claim to reduce material waste through its 3D printing process, which can be inferred from the description of the process itself.
  - 근거: https://www.3dprintingmedia.network/what-is-3d-printing/, https://www.sciencedirect.com/science/article/pii/S2214860420301234
...
- **E1.** Patents that focus on adhesive surfaces or coatings without involving layer-by-layer construction of 3D objects are excluded from the domain.
...
- For photolithography and semiconductor manufacturing, exclude unless they directly involve 3D printing processes.
