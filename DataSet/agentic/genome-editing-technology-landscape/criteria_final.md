...
- **C7.** The invention must facilitate therapeutic applications of genome editing, such as treating genetic diseases or developing new medical treatments.
  - 근거: corpus: task
...
- [CONDITIONAL] **genetic engineering applications** — Genetic engineering applications are in scope if they specifically involve genome editing tools or methods, such as CRISPR or TALENs, for precise DNA modifications.
...
- **E2.** Patents that enhance gene expression without involving genome editing tools or methods, such as those purely focused on transcriptional regulation without DNA modification, are excluded.
  - 근거: corpus: boundary_case
...
- Genetic engineering applications are in scope if they specifically involve genome editing tools or methods, such as CRISPR or TALENs, for precise DNA modifications.
