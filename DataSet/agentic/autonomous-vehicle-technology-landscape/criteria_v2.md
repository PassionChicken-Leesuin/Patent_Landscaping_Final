...
- **E2.** Patents focused on non-vehicle related technologies, such as furniture design or medical rehabilitation, are excluded.
  - 근거: corpus: boundary_case
- **E3.** Patents involving general control systems not directly related to vehicle automation are excluded unless they are specifically applied to autonomous vehicle technology.
  - 근거: corpus: boundary_case
