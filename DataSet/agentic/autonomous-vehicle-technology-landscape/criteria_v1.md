...
- **E2.** Patents focused on non-vehicle related technologies, such as furniture design or medical rehabilitation, are excluded.
  - 근거: corpus: boundary_case
- **E3.** Patents involving general control systems not directly related to vehicle automation are excluded.
  - 근거: corpus: boundary_case
- **E4.** Patents on general imaging or camera systems not specifically for vehicle applications are excluded.
  - 근거: corpus: boundary_case
