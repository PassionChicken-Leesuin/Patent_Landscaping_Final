...
- **C4.** The invention must be described as enabling customization or rapid prototyping in the 3D printing process.
  - 근거: corpus: task, corpus: definition
- **C5.** The invention must be described as ensuring precision or accuracy in the 3D printing process.
  - 근거: corpus: task, corpus: definition
...
- **E2.** Patents that describe monitoring or auxiliary processes without directly contributing to the 3D printing process are excluded.
  - 근거: corpus: boundary_case
- **E3.** Patents that involve technologies like photolithography or semiconductor manufacturing are excluded because they focus on different applications and material handling processes that do not align with the core 3D printing processes.
...
- Patents that mention 3D printing in a non-central context, such as anticounterfeiting applications, should be excluded unless the 3D printing process itself is a core component of the invention.
