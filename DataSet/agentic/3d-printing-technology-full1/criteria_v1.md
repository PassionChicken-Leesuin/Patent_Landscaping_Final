...
- **C3.** The invention must utilize materials such as plastics, metals, ceramics, or biological substances in the printing process.
...
- **E2.** Patents that describe monitoring or auxiliary processes without directly contributing to the 3D printing process are excluded.
  - 근거: corpus: boundary_case
- **E3.** Patents that involve technologies like photolithography or semiconductor manufacturing, which do not align with the core 3D printing processes, are excluded.
  - 근거: corpus: mismatch_with_web_evidence

## 경계 판정 지침

- Patents focusing on specific applications like orthodontic aligners should be excluded unless they describe a novel 3D printing process or system integral to the domain.
