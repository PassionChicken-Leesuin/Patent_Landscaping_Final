...
- **C5.** The technology must include the use of prime editing or TALENs as part of the genome editing techniques.
  - 근거: corpus: Prime editing, https://en.wikipedia.org/wiki/TALEN
...
- **E3.** Patents discussing therapeutic delivery or medical monitoring technologies that do not involve direct genome editing are excluded, as they do not perform the defining tasks of genome editing technology.
  - 근거: corpus: suspected_boundary_cases
- **E4.** Traditional genetic engineering methods that do not involve programmable nucleases like CRISPR, TALENs, or prime editing are excluded, as they do not perform the precise genome editing tasks defined by the domain.
  - 근거: https://en.wikipedia.org/wiki/Genetic_engineering
