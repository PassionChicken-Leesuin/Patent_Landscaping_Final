...
- **C5.** The invention must mention stages of pre-processing, building, and post-processing in the 3D printing process within the abstract.
  - 근거: https://www.sciencedirect.com/science/article/pii/S2214860420301234, https://en.wikipedia.org/wiki/3D_printing
...
- [OUT] **Rapid Prototyping** — Rapid prototyping is not a distinct cluster in the patent pool and is not supported by the evidence as a core part of the domain.
...
- **E2.** Patents that focus on monitoring or auxiliary technologies that do not involve material deposition as part of the 3D printing process are excluded.
  - 근거: corpus: suspected_boundary_cases
- **E3.** Patents that describe components or materials without a clear link to performing the core tasks of 3D printing are excluded.
  - 근거: corpus: suspected_boundary_cases
