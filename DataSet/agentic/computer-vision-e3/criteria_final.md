...
## 도메인 정의
Computer vision is a field focused on enabling machines to interpret and understand visual information from the world, primarily through the processing and analysis of digital images and video. This involves tasks such as object detection, recognition, and tracking, depth estimation, 3D modeling, feature detection and extraction, and scene understanding, often leveraging machine learning techniques to improve accuracy and adaptability. The goal is to automate visual tasks that the human visual system can perform, such as identifying objects, understanding scenes, and extracting meaningful information from visual data.
...
- **C4.** The invention must explicitly mention the use of machine learning techniques, such as neural networks or deep learning, for visual recognition tasks.
...
- **C7.** The invention must involve scene understanding, which includes interpreting the spatial arrangement and relationships between objects in an image or video.
  - 근거: corpus: Computer vision seeks to automate tasks that the human visual system can do., corpus: Computer vision involves the development of a theoretical and algorithmic basis to achieve automatic visual understanding.

## 분석 대상 특허의 범위
The scope of analysis for the computer vision domain includes patents that focus on enabling machines to interpret and understand visual data through techniques such as object detection, recognition, tracking, depth estimation, 3D modeling, feature detection and extraction, and scene understanding. This includes the use of machine learning to enhance these tasks. Patents that merely use visual data for unrelated purposes or focus on non-visual tasks are outside the scope.
...
- For 'Graph generation methods', unless the graph generation directly involves interpreting visual data, it is out of scope. Consider cases where graph generation is used for visual data interpretation as potentially in scope.
