...
## 도메인 정의
Autonomous Vehicle Technology encompasses systems and methods that enable vehicles to operate independently without human intervention. This includes the ability to navigate roads and traffic autonomously, detect and respond to dynamic environmental conditions such as other vehicles, pedestrians, and road signs, ensure passenger safety through collision avoidance and emergency handling systems, integrate with mapping and GPS systems for optimal route determination, utilize vehicle-to-vehicle and vehicle-to-infrastructure communication to enhance situational awareness, employ AI or machine learning techniques for autonomous vehicle operation, and utilize sensor fusion techniques for accurate perception and decision-making.
...
- **C7.** The invention must utilize sensor fusion techniques for accurate perception and decision-making in autonomous vehicle operation.
  - 근거: corpus: technique, corpus: definition

## 분석 대상 특허의 범위
The scope of analysis for Autonomous Vehicle Technology includes patents that specifically enable vehicles to operate independently without human intervention. This encompasses technologies for autonomous navigation, environmental detection and response, safety systems, integration with mapping and GPS, communication systems that enhance situational awareness, the use of AI or machine learning for autonomous operation, and sensor fusion techniques for accurate perception and decision-making. Patents that merely assist human drivers or relate to non-transportation autonomous systems are excluded.
...
- **E1.** Patents that focus on driver assistance systems rather than full autonomy are excluded unless they are integral to autonomous functions.
  - 근거: corpus: task, corpus: technique
...
- **E3.** Patents that address general vehicle components or systems without specific application to autonomous operation are excluded unless they are integral to autonomous functions.
  - 근거: corpus: task, corpus: technique
...
- Patents involving radar and sensor technologies are in if they are used for autonomous navigation and environmental detection, aligning with the patent pool's focus.
