...
- [IN] **Blockchain for energy management** — When blockchain is used to manage energy transactions or data securely and transparently, it performs a defining task of the domain.
